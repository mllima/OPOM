...
h11 = TransferFunctionDelay(num11, den11, delay=10)  # delay in seconds

num12 = [1.5]
den12 = [23*62, 23+62, 1]
h12 = TransferFunctionDelay(num12, den12)

num21 = [-1.4]
den21 = [30*90, 30+90, 1]
h21 = TransferFunctionDelay(num21, den21, delay=0)

num22 = [2.8]
den22 = [90, 1]
h22 = TransferFunctionDelay(num22, den22)
...
g11 = signal.TransferFunction(num11, den11)
T11, y11 = signal.step(g11)
T11 += h11.delay

g12 = signal.TransferFunction(num12, den12)
T12, y12 = signal.step(g12)
T12 += h12.delay

g21 = signal.TransferFunction(num21, den21)
T21, y21 = signal.step(g21)
T21 += h21.delay

g22 = signal.TransferFunction(num22, den22)
